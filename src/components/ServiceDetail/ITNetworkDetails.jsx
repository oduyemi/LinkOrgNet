...
const serviceData = {
  ...
  carouselItems: [
    {
      imgSrc: require("../../assets/images/services/it1.png"),
      title: "Application Security",
      description: "Protect apps from cyber threats.",
      link: "/services/it-networks/app_security",
    },
    {
      imgSrc: require("../../assets/images/services/it2.png"),
      title: "Managed LAN/WAN",
      description: "Comprehensive management ensures optimal performance.",
      link: "/services/it-networks/wan_lan",
    },
    {
      imgSrc: require("../../assets/images/services/it3.jpg"),
      title: "Endpoint Security",
      description: "Safeguard network devices across your business.",
      link: "/services/it-networks/endpoint",
    },
  ],
