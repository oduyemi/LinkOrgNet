...
const serviceData = {
  ...
  carouselItems: [
    ...
    {
      imgSrc: require("../../assets/images/services/sat2.jpg"),
      title: "Maritime Internet",
      description: "Reliable connection for offshore platforms and ships.",
      link: "/services/satellite/maritime",
    },
    {
