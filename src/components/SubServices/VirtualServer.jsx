          ...
          <Box className="row g-5">
            <Box className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
              <Box className="section-title">
                ...
                >
                  Virtual servers are software-based representations of physical
                  servers, created using virtualization technology.
                  <br />
                  <br />
                  Instead of relying on dedicated hardware, multiple virtual
                  servers can run on a single physical server, each functioning
                  independently with its own operating system (OS),
                ...
                <p className="fw-medium blutext">
                  <CheckIcon /> Virtualization
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Hypervisor
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Virtual Machine (VM)
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Resource Sharing
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Isolation
                </p>
