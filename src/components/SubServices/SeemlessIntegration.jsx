...
export const SeemlessIntegrate = () => {
  return (
    <Box>
          ...
          <Box className="row g-5">
            <Box className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
              <Box className="section-title">
                ...
                >
                  Seamless Integration refers to the process of connecting
                  different software systems, applications, or components in a
                  way that allows them to function as a unified whole without
                  disruptions or compatibility issues
                  <br />
                  <br />
                  In a seamless integration, the data flows smoothly between the
                  systems, and users experience a cohesive interaction, as if
                  the systems were designed to work together from the beginning.
                  <br />
                  <br />
                  Key Features of Seamless Integration:
                </Typography>
                <p className="fw-medium blutext">
                  <CheckIcon /> Real-Time Data Exchange
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Cross-Platform Compatibility
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Automation of Processes
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Unified User Interface
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Data Consistency and Accuracy
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> API (Application Programming Interface) Usage
                </p>
