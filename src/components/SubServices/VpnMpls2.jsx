          ...
          <Box className="row g-5">
            <Box className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
              <Box className="section-title">
                ...
                >
                  MPLS L2VPN (Multiprotocol Label Switching Layer 2 Virtual
                  Private Network) is a service that provides Layer 2
                  connectivity over a shared MPLS backbone
                  <br />
                  <br />
                  frames, allowing businesses to connect geographically
                  dispersed locations while maintaining their existing Layer 2
                  protocols.
                  <br />
                  <br />
                ...
                <p className="fw-medium blutext">
                  <CheckIcon /> Layer 2 transparency, maintaining customer
                  network architecture
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Pseudowires for point-to-point or multipoint
                  connections
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Support for flexible topologies (e.g., E-Line,
                  E-LAN)
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Scalability and efficient traffic engineering
                  with QoS
                </p>
