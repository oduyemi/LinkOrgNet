          ...
          <Box className="row g-5">
            <Box className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
              <Box className="section-title">
                ...
                >
                  Estate Connect Internet refers to a dedicated internet service
                  specifically designed for residential estates or gated
                  communities.
                  <br />
                  <br />
                  It provides high-speed, reliable internet connectivity to
                  multiple homes or apartments within an estate through a
                ...
                <p className="fw-medium blutext">
                  <CheckIcon /> Customizable Plans
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Enhanced Security
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Convenience
                </p>
