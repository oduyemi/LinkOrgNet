          ...
          <Box className="row g-5">
            <Box className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
              <Box className="section-title">
                ...
                >
                  Custom Development refers to the process of designing,
                  creating, and deploying software solutions or applications
                  tailored specifically to meet the unique needs and
                  requirements of a business or individual.
                  <br />
                  <br />
                  Unlike off-the-shelf software, custom development is highly
                  specialized and personalized, addressing specific functions,
                  workflows, or challenges that a pre-built solution might not
                  adequately cover.
                  <br />
                  <br />
                ...
                <p className="fw-medium blutext">
                  <CheckIcon /> Tailored Solutions
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Scalability
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Flexibility and Control
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Integration with Existing Systems
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Competitive Advantage
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Ownership
                </p>
