          ...
          <Box className="row g-5">
            <Box className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
              <Box className="section-title">
                ...
                >
                  Data Backup is the process of creating copies of data to
                  protect against loss, corruption, or accidental deletion.
                  <br />
                  <br />
                  These backups serve as a safeguard to restore important
                  information in the event of hardware failure, software issues,
                  cyberattacks, or other data loss incidents.
                  <br />
                  <br />
                  Key Features of Data Backup:
                </Typography>
                <p className="fw-medium blutext">
                  <CheckIcon /> Regular Backup Scheduling
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Version Control
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Full, Incremental, and Differential Backups
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> On-Premises and Cloud Options
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Encryption and Security
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Disaster Recovery
                </p>
                <p className="fw-medium blutext">
