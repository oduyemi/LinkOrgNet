          ...
          <Box className="row g-5">
            <Box className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
              <Box className="section-title">
                ...
                >
                  MPLS L3VPN (Multiprotocol Label Switching Layer 3 Virtual
                  Private Network) is a technology that enables service
                  providers to create secure and scalable IP-based networks for
                  multiple customers over a shared MPLS backbone
                  <br />
                  <br />
                  It uses MPLS for efficient packet forwarding and Virtual
                  Routing and Forwarding (VRF) to isolate customer traffic.
                  <br />
                  <br />
                  Key features of MPLS L3VPN include:
                </Typography>
                <p className="fw-medium blutext">
                  <CheckIcon /> Efficient Routing
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Traffic Isolation
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Scalability
                </p>
                <p className="fw-medium blutext">
                  <CheckIcon /> Traffic Optimization
                </p>
